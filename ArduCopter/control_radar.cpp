...
/*
 * Init and run calls for radar obstacle avoidence flight mode
 */

// radar_init - initialise radar obstacle avoidence controller
bool Copter::radar_init(bool ignore_checks)
{
